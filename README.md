This repository is a fork of the original [metalmatze/digitalocean_exporter](https://github.com/metalmatze/digitalocean_exporter) with the following changes:
